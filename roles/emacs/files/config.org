...
(catppuccin-set-color 'base "#000104") ;; change base to #000000 for the currently active flavor
...
#+begin_src emacs-lisp
(set-face-attribute 'variable-pitch nil :family "JetBrainsMono Nerd Font" :height 145 :weight 'Regular)
(set-face-attribute 'default nil :family "JetBrainsMono Nerd Font" :height 145 :weight 'Regular)
(set-face-attribute 'fixed-pitch nil :family "JetBrainsMono Nerd Font" :height 145 :weight 'Regular)

(setq my/variable-width-font "Iosevka Aile")
