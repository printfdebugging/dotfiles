...
#+begin_src emacs-lisp
(set-face-attribute 'variable-pitch nil         :family "Iosevka Nerd Font" :foreground "#eeffff" :height 180     :weight 'Regular)
(set-face-attribute 'default nil                :family "Iosevka Nerd Font" :foreground "#d8dee9" :height 180     :weight 'Regular)
(set-face-attribute 'fixed-pitch nil            :family "Iosevka Nerd Font" :foreground "#d8dee9" :height 180     :weight 'Regular)
(set-face-attribute 'org-document-title nil     :family "Iosevka Nerd Font" :height 330           :weight 'Bold   :foreground "#bbc2cf")
(set-face-attribute 'org-level-1 nil            :family "Iosevka Nerd Font" :height 300           :weight 'Bold)
(set-face-attribute 'org-level-2 nil            :family "Iosevka Nerd Font" :weight 'Bold         :height 270     :foreground "#A9A1E1")
(set-face-attribute 'org-level-3 nil            :family "Iosevka Nerd Font" :weight 'Bold         :height 220     :foreground "#A9A1E1")
(set-face-attribute 'org-level-4 nil            :family "Iosevka Nerd Font" :height 180           :weight 'Bold)
...
(set-face-attribute 'markdown-code-face nil :height 150 :background "#23272e" :weight 'Regular)
#+END_SRC
