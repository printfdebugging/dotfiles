...
#+begin_src emacs-lisp
(set-face-attribute 'variable-pitch nil :family "JetBrainsMono Nerd Font" :height 100 :weight 'Regular)
(set-face-attribute 'default nil :family "JetBrainsMono Nerd Font" :height 100 :weight 'Regular)
(set-face-attribute 'fixed-pitch nil :family "JetBrainsMono Nerd Font" :height 100 :weight 'Regular)
